  ...
  <div>
    ...
    <ProfileWrapper class="mb-6">
      ...
      >
        ...
        >
         <img src="../../assets/images/Auth/login1.png" alt="" class="w-[400px] hidden md:inline-block">
        </div>
      </div>
    </ProfileWrapper>
    ...
    <ProfileWrapper>
      <div>
        ...
        <UButton class="md:text-xl text-sm px-4 block w-[80%] mx-auto md:mx-0 md:w-fit md:inline-block my-6" color="error" @click="deleteAccount">Delete my Account</UButton>
      </div>
    </ProfileWrapper>
  </div>
</template>
