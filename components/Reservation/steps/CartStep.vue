<template>
      ...
      <div v-if="proceedingToNext" class="mt-6">
        ...
        <div class="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
          ...
          <p class="text-green-600">
            You've chosen to order at the restaurant. Please continue with the reservation process.
          </p>
        </div>
      </div>
  ...
  <Teleport to="body">
    ...
    >
      <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-5xl m-4 max-h-[90vh] overflow-hidden flex flex-col">
        <!-- Header -->
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center sticky top-0 bg-white z-10">
          <h2 class="text-2xl font-bold text-primary">
            {{ formData.mealType === 'breakfast' ? 'Breakfast Menu' : 'Dinner Menu' }}
          </h2>
            ...
            >
              <div class="flex flex-col h-full">
                ...
                <div class="p-4 flex flex-col flex-grow">
                  ...
                  <p class="text-gray-600 mb-auto">{{ item.description }}</p>
                  
                  <!-- Quantity Controls -->
                  <div class="flex items-center justify-end mt-4">
                    <div v-if="getCartItem(item.id)" class="flex items-center space-x-3 border border-gray-200 rounded-lg px-2 py-1">
                      <UButton
                      ...
                      />
                      <span class="text-lg font-medium w-6 text-center">{{ getCartItem(item.id).quantity }}</span>
                      <UButton
          ...
          <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div v-if="cartItems.length > 0" class="flex items-center">
              ...
              <div class="font-bold text-lg">
                ...
                <span class="text-primary">${{ calculateTotal().toFixed(2) }}</span>
              </div>
            </div>
...
const categories = computed(() => {
  const all = ['All'];
  const uniqueCategories = [...new Set(filteredMenu.value.map(item => item.category))];
...
const menu = [
  // Breakfast items
  {
    ...
    price: 12.99,
    image: new URL('@/assets/images/Menu/Appetizer/ChickenWings.png', import.meta.url).href
  },
  {
    id: 'b2',
    type: 'breakfast',
    ...
    price: 9.99,
    image: new URL('@/assets/images/Menu/Appetizer/GarlicBread.png', import.meta.url).href
  },
  {
    id: 'b3',
    type: 'breakfast',
    ...
    price: 10.99,
    image: new URL('@/assets/images/Menu/Main/GrilledChickenFillet.png', import.meta.url).href
    },
  // Dinner items
  {
    id: 'd1',
    ...
    price: 24.99,
    image: new URL('@/assets/images/Menu/Main/StuffedSeaBass.png', import.meta.url).href
  },
  {
    id: 'd2',
    type: 'dinner',
    ...
    price: 29.99,
    image: new URL('@/assets/images/Menu/Pasta/SpaghettiBolognese.png', import.meta.url).href
  },
  {
    id: 'd3',
    type: 'dinner',
    ...
    price: 18.99,
    image: new URL('@/assets/images/Menu/Pasta/TagliatelleFruitt.png', import.meta.url).href
  }
];
...
const filteredMenuByCategory = computed(() => {
  ...
  return filteredMenu.value.filter(item => item.category === selectedCategory.value);
});
