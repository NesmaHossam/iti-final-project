    ...
    <div>
      ...
      <div class="mb-6">
        ...
        <input 
          ...
          min="2025-04-03"
          @input="updateDate"
          class="block w-full max-w-md rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50 p-2 border-2"
        />
      </div>
      <p v-if="formData.date" class="text-primary text-sm mt-4">
...
const selectedDate = ref(new CalendarDate(today.getFullYear(), today.getMonth() + 1, today.getDate()));
